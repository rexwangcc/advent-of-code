...
if __name__ == "__main__":
    ...
    intersections = get_intersections(wire_footprints(wire_1), wire_footprints(wire_2))
    print(intersections)
    print(
        f"Answer in a sorted list is {sorted(list(map(manhattan_distance, intersections)))}"
    )
